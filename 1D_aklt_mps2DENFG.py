...
expectation_z0_mps = aklt.SingleSpinMeasure(0, z)
expectation_z1_mps = aklt.SingleSpinMeasure(1, z)
expectation_z2_mps = aklt.SingleSpinMeasure(2, z)
expectation_z3_mps = aklt.SingleSpinMeasure(3, z)
...
plt.legend(['$P(n_0=+1)$', '$P(n_0=-1)$'], loc='upper left')
plt.twinx()
